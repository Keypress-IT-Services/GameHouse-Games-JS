...
'use strict';
{
    ...
    window.RuntimeInterface = class RuntimeInterface {
        constructor(opts) {
            ...
            if (this._useWorker && (typeof OffscreenCanvas === "undefined" || !navigator["userActivation"] || this._scriptsType === "module" && !SupportsWorkerTypeModule()))
        ...
        async _InitDOM(opts, port2) {
            ...
            } else if (opts.projectScripts && opts.projectScripts.length > 0)
                try {
